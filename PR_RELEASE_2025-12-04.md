...
1. **Vercel 빌드 오류 수정** (Critical)
   ...
   - `apps/sum-api/lib/credit-scheduler.ts` - getter를 사용한 lazy initialization
   - `apps/sum-api/lib/services/notification-service.ts` - getter를 사용한 lazy initialization
   - `apps/sum-api/app/api/admin/test-daily-grant/route.ts` - dynamic import 적용
   - `apps/sum-diary/vercel.json` - corepack을 사용한 pnpm 버전 지정
   - `apps/sum-api/vercel.json` - corepack을 사용한 pnpm 버전 지정
...
주요 변경 파일:
- `apps/sum-api/lib/credit-scheduler.ts`
- `apps/sum-api/lib/services/notification-service.ts`
- `apps/sum-api/app/api/admin/test-daily-grant/route.ts`
- `apps/sum-api/app/api/**/*.ts` (타입 어노테이션 추가)
- `apps/sum-diary/docs/patterns/build-time-module-execution.md`
- `apps/sum-diary/docs/patterns/vercel-pnpm-version.md`
- `apps/sum-diary/docs/patterns/README.md`
- `apps/sum-diary/vercel.json` (pnpm 버전 지정)
- `apps/sum-api/vercel.json` (pnpm 버전 지정)
...
주요 커밋:
- `fix(sum-api): use dynamic import for credit-scheduler in test route`
- `fix(sum-api): use lazy initialization for Supabase clients`
- `fix(sum-api): add type annotations for Supabase queries`
...
- [Pattern: Build-Time Module Execution](./apps/sum-diary/docs/patterns/build-time-module-execution.md)
- [Pattern: Vercel pnpm Version](./apps/sum-diary/docs/patterns/vercel-pnpm-version.md)
