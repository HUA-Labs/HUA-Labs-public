...
변경된 파일:
- apps/sum-diary/app/admin/diaries/[id]/page.tsx
- apps/sum-diary/app/admin/diaries/[id]/components/DiaryInfoCard.tsx
```
...
```bash
# 어드민 일기 상세 페이지 개선 커밋
git add apps/sum-diary/app/admin/diaries/[id]/
...
- [Git Flow 가이드](../apps/sum-diary/scripts/gitflow/README.md)
