...
- **Swagger 설정**: `apps/sum-api/lib/swagger/config.ts`
- **API 문서 페이지**: `apps/sum-api/app/api-docs/page.tsx`
- **Swagger JSON 엔드포인트**: `apps/sum-api/app/api/swagger.json/route.ts`
