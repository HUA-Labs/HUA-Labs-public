...
**올바른 위치**: `apps/sum-diary/auth.d.ts`

```typescript
// ✅ 올바른 파일명
// apps/sum-diary/auth.d.ts
declare module "next-auth" {
  // ...
}
```

**잘못된 위치**: `apps/sum-diary/next-auth.d.ts`
...
- [NextAuth v5 타입 확장 문제 및 해결](../../../apps/sum-diary/docs/DEVLOG_2025-12-24_NEXTAUTH_TYPE_AUGMENTATION_ISSUE.md)
