...
이 폴더는 `sum-diary` 앱의 내부 개발 문서를 포함합니다. 공개 문서는 [`apps/sum-diary/docs/`](../../../apps/sum-diary/docs/)에서 확인할 수 있습니다.
...
공개 문서는 [`apps/sum-diary/docs/`](../../../apps/sum-diary/docs/)에서 확인할 수 있습니다:
- [README.md](../../../apps/sum-diary/docs/README.md) - 앱 개요
- [PROJECT_INTRODUCTION.md](../../../apps/sum-diary/docs/PROJECT_INTRODUCTION.md) - 프로젝트 소개
- [ARCHITECTURE_AND_FEATURES.md](../../../apps/sum-diary/docs/ARCHITECTURE_AND_FEATURES.md) - 아키텍처 및 기능
- [DATABASE_SCHEMA.md](../../../apps/sum-diary/docs/DATABASE_SCHEMA.md) - 데이터베이스 스키마
- [PERFORMANCE_OPTIMIZATION_GUIDE.md](../../../apps/sum-diary/docs/PERFORMANCE_OPTIMIZATION_GUIDE.md) - 성능 최적화 가이드
- [architecture/](../../../apps/sum-diary/docs/architecture/) - 아키텍처 상세 문서
