...
```bash
# 쉼표로 구분하여 여러 봇 허용
ALLOWED_BOT_USER_AGENTS=hua-bot,sum-diary-bot,monitoring-bot,custom-bot
```
...
- **우리 봇**: `hua-bot`, `sum-diary-bot`, `hua-monitor`
...
ALLOWED_BOT_USER_AGENTS=hua-bot,sum-diary-bot,monitoring-bot
```
