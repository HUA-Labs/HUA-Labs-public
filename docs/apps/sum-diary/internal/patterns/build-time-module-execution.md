...
- [`credit-scheduler.ts`](../../../sum-api/lib/credit-scheduler.ts)
- [`notification-service.ts`](../../../sum-api/lib/services/notification-service.ts)
- [`test-daily-grant/route.ts`](../../../sum-api/app/api/admin/test-daily-grant/route.ts)
...
1. `apps/sum-api/lib/credit-scheduler.ts` (수정)
2. `apps/sum-api/lib/services/notification-service.ts` (수정)
3. `apps/sum-api/app/api/admin/test-daily-grant/route.ts` (수정)
