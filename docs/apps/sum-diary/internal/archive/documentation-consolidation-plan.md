...
- 총 **105개의 마크다운 파일**이 `apps/sum-diary/docs/` 폴더에 존재 (archive 포함)
- 루트 핵심 문서: **11개** (정리 완료)
...
docs/
├── devlogs/
│   ├── DEVLOG_2025-12-08.md (sum-diary에서 이동)
│   ├── DEVLOG_2025-12-09.md (sum-diary에서 이동)
│   ├── DEVLOG_2025-12-14_UUIDV7_MIGRATION_AND_CRITICAL_FIXES.md (sum-diary에서 이동)
│   └── DEVLOG_2025-12-15_BUILD_FIXES_AND_PRISMA_7_MIGRATION.md (sum-diary에서 이동)
│
└── patterns/
    ├── build-errors.md (확장)
...
### sum-diary `docs/` (2025-12-16 최종 구조)
```
apps/sum-diary/docs/
├── README.md (업데이트 완료)
├── PROJECT_INTRODUCTION.md
...
3. **README 업데이트**
   - [x] sum-diary `docs/README.md` 업데이트 완료
