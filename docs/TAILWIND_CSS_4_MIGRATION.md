...
**적용된 파일:**
- `apps/sum-api/postcss.config.js`
- `apps/sum-diary/postcss.config.js`
- `apps/sum-chat/postcss.config.js`
...
**적용된 파일:**
- `apps/sum-api/app/globals.css`
- `apps/sum-chat/src/app/globals.css`
- `apps/sum-diary/app/globals.css`
...
- `apps/sum-diary` - 타입 에러 발생 (`nickname_hash` 속성 누락)
