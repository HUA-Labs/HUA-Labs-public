...
### 랜딩 페이지 (landing.json)
- `apps/sum-diary/app/lib/translations/ko/landing.json`
- `apps/sum-diary/app/lib/translations/en/landing.json`
- `apps/sum-diary/app/lib/translations/ja/landing.json`
...
### 일기 관련 (diary.json)
- `apps/sum-diary/app/lib/translations/ko/diary.json`
- `apps/sum-diary/app/lib/translations/en/diary.json`
- `apps/sum-diary/app/lib/translations/ja/diary.json`
