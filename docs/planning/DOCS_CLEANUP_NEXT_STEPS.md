...
- [x] `apps/sum-diary/docs/devlog/` → `docs/devlogs/2026-01/`로 이동

#### 2. sum-diary guides 중복 파일 삭제
- [x] `apps/sum-diary/docs/guides/`에서 archive와 중복된 파일 삭제

---

### Phase 1: sum-diary 문서 중앙집중화 ✅

#### 1.1 apps/sum-diary/docs/ → docs/apps/sum-diary/ 통합
- [x] architecture/ 이동
- [x] database/ 이동
...
- [x] `apps/sum-diary/docs/README.md` 간소화 (중앙 문서 링크만)

#### 1.2 docs/apps/sum-diary/internal/ 정리
...
**형식:** `{날짜}-{프로젝트}-{주제}.md`
- 소문자, 대시(-) 구분
- 예: `2026-01-27-sum-diary-multilang-prompt-test.md`
