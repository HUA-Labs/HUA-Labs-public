...
현재 상황:
- 루트 .gitignore ✅ (통합됨)
- apps/sum-api/.gitignore (삭제 예정)
- apps/sum-chat/.gitignore (삭제 예정)
- apps/sum-diary/.gitignore (삭제 예정)
- packages/hua-i18n-sdk/.gitignore (삭제 예정)
- packages/hua-sum-api-sdk/.gitignore (삭제 예정)
...
현재 상황:
- 루트 README.md ✅ (업데이트됨)
- apps/sum-api/README.md ✅ (간소화 완료)
- apps/sum-chat/README.md ✅ (간소화 완료)
- apps/sum-diary/README.md ✅ (간소화 완료)
...
- apps/sum-api/eslint.config.mjs (삭제 예정)
- apps/sum-chat/eslint.config.mjs (삭제 예정)
- apps/sum-diary/eslint.config.mjs (삭제 예정)
...
정리 방법:
- apps/sum-api/.env → infra/sum-api/.env
- apps/sum-chat/.env → infra/sum-chat/.env
- apps/sum-diary/.env → infra/sum-diary/.env
- 공통 환경 변수는 루트 .env
```
