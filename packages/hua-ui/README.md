...
HUA UI is organized into modular entry points for optimal bundle size. Import only the components you need from specific entry points.

| Entry | Path | Description |
|-------|------|-------------|
| Core | `@hua-labs/ui` | Atomic components (Button, Card, Badge, Alert, Progress, Skeleton, etc.) |
| Form | `@hua-labs/ui/form` | Form components (Input, Select, DatePicker, Upload, Autocomplete, etc.) |
| Navigation | `@hua-labs/ui/navigation` | Navigation & page transition (Breadcrumb, Pagination, PageTransition) |
| Overlay | `@hua-labs/ui/overlay` | Overlay components (Modal, Popover, Dropdown, Drawer, BottomSheet) |
| Data | `@hua-labs/ui/data` | Data display (Table, CodeBlock, InlineCode) |
| Interactive | `@hua-labs/ui/interactive` | Interactive components (Accordion, Tabs, Menu, ContextMenu, Command) |
| Feedback | `@hua-labs/ui/feedback` | Toast notifications (ToastProvider, useToast) |
| Advanced | `@hua-labs/ui/advanced` | Specialized components (Emotion*, Dashboard, Scrollbar, etc.) |

```tsx
// Core atomic components
import { Button, Card, Badge, Alert, Progress, Skeleton } from '@hua-labs/ui';
...
import { Breadcrumb, Pagination, PageTransition } from '@hua-labs/ui/navigation';
...
HUA UI는 번들 크기 최적화를 위한 모듈식 진입점으로 구성됩니다. 필요한 컴포넌트만 특정 진입점에서 import하세요.

| 진입점 | 경로 | 설명 |
|--------|------|------|
| Core | `@hua-labs/ui` | 원자적 컴포넌트 (Button, Card, Badge, Alert, Progress, Skeleton 등) |
| Form | `@hua-labs/ui/form` | 폼 컴포넌트 (Input, Select, DatePicker, Upload, Autocomplete 등) |
| Navigation | `@hua-labs/ui/navigation` | 네비게이션 & 페이지 전환 (Breadcrumb, Pagination, PageTransition) |
| Overlay | `@hua-labs/ui/overlay` | 오버레이 컴포넌트 (Modal, Popover, Dropdown, Drawer, BottomSheet) |
| Data | `@hua-labs/ui/data` | 데이터 표시 (Table, CodeBlock, InlineCode) |
| Interactive | `@hua-labs/ui/interactive` | 인터랙티브 컴포넌트 (Accordion, Tabs, Menu, ContextMenu, Command) |
| Feedback | `@hua-labs/ui/feedback` | Toast 알림 (ToastProvider, useToast) |
| Advanced | `@hua-labs/ui/advanced` | 특수 컴포넌트 (Emotion*, Dashboard, Scrollbar 등) |
