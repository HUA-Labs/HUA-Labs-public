 ...
 *
 * Checks if the user is running an outdated version of create-hua-ux
...
async function getLatestVersion(): Promise<string | null> {
  try {
    const { stdout } = await execAsync('npm view create-hua-ux version', {
...
function displayCacheClearInstructions() {
  ...
  console.log(chalk.white('   npm create hua-ux@latest my-app'));
  console.log();
}
