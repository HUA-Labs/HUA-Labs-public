...
export function WelcomePage({
  ...
  const features = [
    {
      ...
      description: isKo ? '사전 제작된 접근성 컴포넌트' : 'Pre-built, accessible components',
      icon: '🎨',
    },
    {
    ...
    },
    {
      ...
      description: isKo ? '부드러운 애니메이션과 전환' : 'Smooth animations and transitions',
      icon: '✨',
    },
    {
      title: isKo ? 'AI-First' : 'AI-First',
      description: isKo ? 'AI와 함께 빠르게 개발' : 'Built for vibe coding with AI',
      icon: '🤖',
    },
  ];
  ...
  const quickLinks = [
    {
      title: isKo ? '문서' : 'Docs',
      description: isKo ? 'hua-ux 사용 방법 알아보기' : 'Learn how to use hua-ux',
    ...
    {
      title: isKo ? '템플릿' : 'Templates',
      description: isKo ? '예제 템플릿으로 시작하기' : 'Start with example templates',
      href: 'https://github.com/HUA-Labs/hua-platform/tree/main/examples',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      href: 'https://github.com/HUA-Labs/hua-platform',
      icon: (
    ...
    >
      <div className="min-h-screen flex flex-col items-center justify-center p-8 font-sans bg-background text-foreground">
        <main className="max-w-4xl w-full flex flex-col items-center gap-12">
          ...
          >
            ...
            <p className="text-muted-foreground text-center max-w-md">
              {isKo
                ? 'UI, 모션, i18n이 통합된 React UX 프레임워크로 빠르게 시작하세요'
        ...
        >
          ...
          <p>
            {isKo ? '로 만듦' : 'Built with'}{' '}
            <span className="font-mono text-foreground">@hua-labs/hua-ux</span>
          </p>
        </footer>
      </div>
    </HuaUxPage>
