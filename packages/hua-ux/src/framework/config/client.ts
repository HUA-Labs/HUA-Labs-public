/**
 * @hua-labs/hua-ux/framework - Config System (Client-safe)
 *
 ...
 */
export function _getCachedConfig(): HuaUxConfig | null {
  return cachedConfig;
}
 ...
 */
export function _setCachedConfig(config: HuaUxConfig | null): void {
  cachedConfig = config;
}
