 ...
 * Next.js version
 */
export declare const NEXTJS_VERSION = "16.1.6";
/**
 * React version
 */
export declare const REACT_VERSION = "19.2.3";
/**
 * React DOM version (should match React version)
 */
export declare const REACT_DOM_VERSION = "19.2.3";
/**
 ...
 */
export declare const TYPES_NODE_VERSION = "^25.0.3";
/**
 * React types version
 */
 ...
 */
export declare const PHOSPHOR_ICONS_VERSION = "^2.1.10";
