...
- **예시**: `apps/sum-diary/app/types/api.ts`
...
```typescript
// apps/sum-diary/app/types/api.ts
...
- API 타입 예시: `apps/sum-diary/app/types/api.ts`
- 데이터베이스 타입: `apps/sum-api/lib/types/database.ts`
