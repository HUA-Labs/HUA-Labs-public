...
#### 4. sum-chat → apps/sum-chat
```bash
# sum-chat 폴더의 모든 내용을 apps/sum-chat으로 복사
xcopy "G:\HUA\sum-chat\*" "G:\HUA\hua-platform\apps\sum-chat\" /E /I /H
...
xcopy "G:\HUA\sum-chat" "G:\HUA\backup\sum-chat\" /E /I /H
