          ...
          <section>
            ...
            <div className="mt-4">
              <pre className="bg-slate-900 text-slate-100 p-4 rounded-lg overflow-x-auto">
                <code>{`import { Panel, Action } from '@hua-labs/hua'
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Panel style="elevated" padding="large">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Action variant="outline" size="sm">구매하기</Action>
                  </div>
                </Panel>
                ...
                <Panel style="glass" padding="large">
                  ...
                  <Action variant="glass">시작하기</Action>
                </Panel>
                ...
                <Panel style="outline" padding="large">
                  ...
                  <Action variant="outline">더 알아보기</Action>
                </Panel>
              </div>
            </div>
            <div className="mt-4">
