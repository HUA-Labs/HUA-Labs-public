...
|---------|-------------|-----|
| [SUM Diary](./apps/sum-diary) | AI 기반 감정 분석 일기 서비스 | [sumdiary.com](https://sumdiary.com) |
...
```
feat: new feature [deploy sum-diary]
